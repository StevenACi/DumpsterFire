...
class bash_aliases_fake_filesystem_errors( FireModule ):
	...
	def Description( self ):
		self.Description = "Appends a series of aliases to the supplied bash resource file, print(ng system error messages when attempting to use commands such as 'ls', 'cd', 'df', etc. NOTE: Changing the global bash resource file requires root privileges.")
